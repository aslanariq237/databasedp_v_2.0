...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div class="">
            ...
            <p class="text-sm text-gray-500 font-semibold">Document - Admin</p>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 flex items-end justify-end text-sm gap-2">                                                        
                            @if (!$receive->has_invoice)
                                <a 
                                    href="{{ route('admin.show', $receive->receive_id) }}" 
                                ...
                                <a 
                                    ...
                                    class="inline-flex items-center px-2 py-2.5 bg-yellow-600 text-white font-medium rounded-lg shadow-md hover:bg-yellow-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-all duration-200">
